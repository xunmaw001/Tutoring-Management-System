...
var centerMenu = [
    ...
    ,{
        name: '教师收藏',
        url: '../jiaoshiCollection/list.html'
    }
    ,{
        name: '教师评价',
        url: '../jiaoshiCommentback/list.html'
    }
    ,{
        name: '预约信息',
        url: '../jiaoshiYuyue/list.html'
    }
    ,{
        name: '课程收藏',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/jiajiaoyuyueguanli/admin/dist/index.html#/login";
