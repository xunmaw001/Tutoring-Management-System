  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='jiaoshi'"  label='预约价格' prop="jiaoshiMone">
               <el-input v-model="ruleForm.jiaoshiMone"  placeholder='预约价格' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='jiaoshi'"  label='现有余额' prop="newMoney">
         ...
         <el-col :span="24">
             <el-form-item v-if="flag=='jiaoshi'"  label="个人介绍" prop="jiaoshiContent">
                 <editor
...
// 注册表 教师 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.jiaoshiMone)&& 'jiaoshi'==this.flag){
