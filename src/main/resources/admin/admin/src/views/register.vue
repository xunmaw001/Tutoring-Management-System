    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">家教管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="预约价格" class="input" v-if="tableName=='jiaoshi'">
                                <el-input v-model="ruleForm.jiaoshiMone" autocomplete="off" placeholder="预约价格"  />
                           </el-form-item>
                        -->
                        <!--
                        ...
                        -->
                        <!--
                            <el-form-item label="现有余额" class="input" v-if="tableName=='jiaoshi'">
                                <el-input v-model="ruleForm.newMoney" autocomplete="off" placeholder="现有余额"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="个人介绍" class="input" v-if="tableName=='jiaoshi'">
                                <el-input type="textarea" v-model="ruleForm.jiaoshiContent" placeholder="个人介绍"></el-input>
                           </el-form-item>
                        -->
                        <!--
                        ...
                        -->
                        <!--
                            <el-form-item label="创建时间 show1 show2 photoShow" class="input" v-if="tableName=='jiaoshi'">
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // jiaoshi 中的 预约价格 判空处理
                            // if('jiaoshi' == this.tableName && (this.ruleForm.jiaoshiMone== null ||this.ruleForm.jiaoshiMone== "")){
                            //     this.$message.error("预约价格不能为空");
                            //     return
                            // }
                            ...
                            //     return
                            // }
                            // jiaoshi 中的 现有余额 判空处理
                            // if('jiaoshi' == this.tableName && (this.ruleForm.newMoney== null ||this.ruleForm.newMoney== "")){
                            //     this.$message.error("现有余额不能为空");
                            //     return
                            // }
                            // jiaoshi 中的 个人介绍 判空处理
                            // if('jiaoshi' == this.tableName && (this.ruleForm.jiaoshiContent== null ||this.ruleForm.jiaoshiContent== "")){
                            ...
                            //     return
                            // }
                            // jiaoshi 中的 创建时间 show1 show2 photoShow 判空处理
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/jiajiaoyuyueguanli/img/back-img-bg.jpg);
