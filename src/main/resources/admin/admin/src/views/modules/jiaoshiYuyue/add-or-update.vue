    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaoshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="预约价格" prop="jiaoshiMone">
                        <el-input v-model="jiaoshiForm.jiaoshiMone"
                                  placeholder="预约价格" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="预约价格" prop="jiaoshiMone">
                            <el-input v-model="ruleForm.jiaoshiMone"
                                      placeholder="预约价格" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='jiaoshi' ">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预约编号" prop="jiaoshiYuyueUuidNumber">
                       <el-input v-model="ruleForm.jiaoshiYuyueUuidNumber"
                                 placeholder="预约编号" clearable  :readonly="ro.jiaoshiYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="预约编号" prop="jiaoshiYuyueUuidNumber">
                           <el-input v-model="ruleForm.jiaoshiYuyueUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="预约信息" prop="jiaoshiYuyueText">
                        <el-input type="textarea"  :readonly="ro.jiaoshiYuyueText" v-model="ruleForm.jiaoshiYuyueText" placeholder="预约信息"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiaoshiYuyueText" label="预约信息" prop="jiaoshiYuyueText">
                            <span v-html="ruleForm.jiaoshiYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.jiaoshiYuyueTime"  class="input" label="预约时间" prop="jiaoshiYuyueTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.jiaoshiYuyueTime"
                                type="datetime"
                                placeholder="预约时间"
                                :disabled="ro.jiaoshiYuyueTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiaoshiYuyueTime" label="预约时间" prop="jiaoshiYuyueTime">
                            <span v-html="ruleForm.jiaoshiYuyueTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.jiaoshiYuyueYesnoTypes" label="审核状态" prop="jiaoshiYuyueYesnoTypes">
                        <el-input v-model="ruleForm.jiaoshiYuyueYesnoValue" placeholder="审核状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.jiaoshiYuyueYesnoText" label="审核回复" prop="jiaoshiYuyueYesnoText">
                        <span v-html="ruleForm.jiaoshiYuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="预约状态" prop="jiaoshiYuyueTypes">
                        <el-select v-model="ruleForm.jiaoshiYuyueTypes" :disabled="ro.jiaoshiYuyueTypes" placeholder="请选择预约状态">
                            <el-option
                                v-for="(item,index) in jiaoshiYuyueTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="预约状态" prop="jiaoshiYuyueValue">
                        <el-input v-model="ruleForm.jiaoshiYuyueValue"
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    jiaoshiYuyueUuidNumber: true,
                    jiaoshiId: false,
                    yonghuId: false,
                    jiaoshiYuyueText: false,
                    jiaoshiYuyueTime: false,
                    jiaoshiYuyueYesnoTypes: false,
                    jiaoshiYuyueYesnoText: false,
                    jiaoshiYuyueTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    ...
                    jiaoshiYuyueText: '',
                    jiaoshiYuyueTime: '',
                    jiaoshiYuyueYesnoTypes: '',
                    jiaoshiYuyueYesnoText: '',
                    jiaoshiYuyueTypes: '',
                    insertTime: '',
                },
                jiaoshiYuyueYesnoTypesOptions : [],
                jiaoshiYuyueTypesOptions : [],
                jiaoshiOptions : [],
                yonghuOptions : [],
                rules: {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiaoshi_yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jiaoshiYuyueYesnoTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiaoshi_yuyue_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jiaoshiYuyueTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jiaoshiYuyue/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jiaoshiYuyueCrossAddOrUpdateFlag = false;
                                        this.parent.search();
