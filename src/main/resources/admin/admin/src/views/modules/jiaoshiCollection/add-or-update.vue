    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="jiaoshiCollectionTypes">
                        <el-select v-model="ruleForm.jiaoshiCollectionTypes" :disabled="ro.jiaoshiCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in jiaoshiCollectionTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="类型" prop="jiaoshiCollectionValue">
                        <el-input v-model="ruleForm.jiaoshiCollectionValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    jiaoshiId: false,
                    yonghuId: false,
                    jiaoshiCollectionTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    jiaoshiId: '',
                    yonghuId: '',
                    jiaoshiCollectionTypes: '',
                    insertTime: '',
                },
                jiaoshiCollectionTypesOptions : [],
                jiaoshiOptions : [],
                yonghuOptions : [],
                rules: {
                   jiaoshiId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiaoshi_collection_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jiaoshiCollectionTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jiaoshiCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jiaoshiCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();
