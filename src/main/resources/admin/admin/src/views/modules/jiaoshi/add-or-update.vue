        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预约价格" prop="jiaoshiMone">
                       <el-input v-model="ruleForm.jiaoshiMone"
                                 placeholder="预约价格" clearable  :readonly="ro.jiaoshiMone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.jiaoshiContent"  label="个人介绍" prop="jiaoshiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiaoshiContent" label="个人介绍" prop="jiaoshiContent">
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.jiaoshiContent = _this.ruleForm.jiaoshiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.jiaoshiContent = this.ruleForm.jiaoshiContent.replaceAll(this.$base.url,"");
                        this.$http({
